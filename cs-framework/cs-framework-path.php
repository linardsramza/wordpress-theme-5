 ...
 *
 */
if ( ! function_exists( 'otm_get_option' ) ) {
  function otm_get_option( $option_name = '', $default = '' ) {

    $options = apply_filters( 'otm_get_option', get_option( CS_OPTION ), $option_name, $default );
 ...
 *
 */
if ( ! function_exists( 'otm_get_multilang_option' ) ) {
  function otm_get_multilang_option( $option_name = '', $default = '' ) {

    $value     = otm_get_option( $option_name, $default );
